  ...
  }, 
  {
    ...
    "args0": [
      ...
      },
      {
        ...
        "name": "TYPE",
        "options": [
          ["%{BKY_VARIABLES_IS_CHARACTER}", "CHARACTER"],
          ["%{BKY_VARIABLES_IS_TEXT}", "TEXT"],
          ["%{BKY_VARIABLES_IS_BOOLEAN}", "BOOLEAN"],
          ["%{BKY_VARIABLES_IS_SHORT}", "SHORT"],
          ["%{BKY_VARIABLES_IS_NUMBER}", "INT"],
          ["%{BKY_VARIABLES_IS_LONG}", "LONG"],
          ["%{BKY_VARIABLES_IS_DECIMAL}", "DECIMAL"]
        ]
      }
    ],
    "inputsInline": true,
...
},
{
  ...
  "nextStatement": null,
  "colour": "%{BKY_VARIABLES_HUE}",
  "tooltip": "%{BKY_VARIABLES_SHOW}",
  "helpUrl": ""
},
{
  "type": "variable_hide",
  "message0": "ocultar variable %1",
  "args0": [
    {
      "type": "field_variable",
      "name": "ITEM",

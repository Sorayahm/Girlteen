...
Blockly.Msg["ARDUINO_FUNCTION"] = "Estructura básica de Arduino";
Blockly.Msg["ARDUINO_ES_SET_DIGITAL"] = "Escribir los valores HIGH o LOW para un puerto digital especifico ";
Blockly.Msg["ARDUINO_ES_SET_ANALOG"] = "Escribir los valores para un puerto analogico especifico ";
Blockly.Msg["ARDUINO_ES_SET_BUILTIN"] = "LED on u off en Arduino ";
Blockly.Msg["ARDUINO_ES_STATE"] = "Estado de los pines ";
Blockly.Msg["ARDUINO_ES_READ"] = "Medida de la duración de un pulso en el pin seleccionado";
Blockly.Msg["ARDUINO_ES_READ_TIMEOUT"] = "Medida de la duración de un pulso en el pin seleccionado, sin superar el tiempo indicado";
Blockly.Msg["ARDUINO_ES_READ_DIGITAL"] = "Estado de los pines digitales";
Blockly.Msg["ARDUINO_ES_READ_ANALOG"] = "Estado de los pines analogicos";
Blockly.Msg["ARDUINO_ES_READ_ANALOG"] = "Estado de los pines analogicos";
Blockly.Msg["ARDUINO_PROMPT"] = "Entrada utilizada para algunos textos";
Blockly.Msg["ARDUINO_MOVE_STEPPER"] = "Número de pasos del motor especificado";
Blockly.Msg["ARDUINO_READ_SERVO"] = "Servo que lee del pin especificado";
Blockly.Msg["ARDUINO_TIME_MILLISECOND"] = "Espera de X milisegundos (Max 50 días)";
Blockly.Msg["ARDUINO_TIME_MICROSECOND"] = "Espera de X microsegundos (Max 70 minutos)";
Blockly.Msg["ARDUINO_TIME_FOREVER"] = "El evento esperara siempre hasta que finalice el programa";
Blockly.Msg["ARDUINO_SERIAL"] = "Velocidad del puerto serie especificado";
Blockly.Msg["ARDUINO_SERIAL_PRINT"] = "Imprime datos por consola/puerto serie";
Blockly.Msg["ARDUINO_SET_SERVO"] = "Configurar un motor con un ángulo especificado";
Blockly.Msg["ARDUINO_SET_STEPPER_MOTOR"] = "Configurar los pin de entrada de un motor y otras configuraciones";
...
Blockly.Msg["CONTROLS_FOREVER"] = "Repetir sin fin este bucle";
...
Blockly.Msg["CONTROL_TIME_SECOND"] = "Espera de X milisegundos (Max 50 días)";
...
Blockly.Msg["CONTROLS_DOWHILE_TOOLTIP"] = "Hacer algunas declaraciones, mientras no se llegue al valor indicado";
Blockly.Msg["CONTROLS_DOWHILE_HELPURL"] = "https://developer.mozilla.org/es/docs/Web/JavaScript/Referencia/Sentencias/do...while";
...
Blockly.Msg["FUNCTIONS"] = "Secuencia de operaciones que se utilizarán durante el programa";
Blockly.Msg["FUNCTIONS_RETURN"] = "Secuencia de operaciones que se utilizarán durante el programa que devuelve un dato especifico";
Blockly.Msg["IF_RETURN"] = "Si se cumple la condición devuelve un dato especifico";
...
Blockly.Msg["SCRATCH_BOUNCE"] = "Si el elemento se encuentra en el borde de la pantalla este rebotará hasta una posición aleatoria";
Blockly.Msg["SCRATCH_BROADCAST"] = "El evento se producirá al emitir el mensaje especificado";
Blockly.Msg["SCRATCH_CHANGE_SIZE"] = "Cambiar el tamaño del elemento en pixeles";
Blockly.Msg["SCRATCH_CHANGE_SIZE_PERCENTAGE"] = "Cambiar el tamaño del elemento en porcentaje";
Blockly.Msg["SCRATCH_CHANGE_X"] = "Cambiar la posición del elemento con respecto a la coordenada x";
Blockly.Msg["SCRATCH_CHANGE_Y"] = "Cambiar la posición del elemento con respecto a la coordenada y";
Blockly.Msg["SCRATCH_WHEN_FLAG"] = "Cuando se coloca este evento se realizan las siguientes operaciones";
Blockly.Msg["SCRATCH_DEGREES"] = "Colocar el elemento en un grado especifico";
Blockly.Msg["SCRATCH_GLIDE"] = "Desplazar un elemento durante un cierto tiempo hacia una posición aleatoria o elegida por el cursor, (Max. 1 día)";
Blockly.Msg["SCRATCH_GLIDE_COORDENATE"] = "Desplazar un elemento durante un cierto tiempo hacia una posición x y, (Max. 1 día)";
Blockly.Msg["SCRATCH_GO_TO"] = "Colocar el elemento en una posición aleatoria o escogida mediante el cursor";
Blockly.Msg["SCRATCH_GO_TO_COORDENATE"] = "Colocar el elemento en una posición x y, (-100,100)";
Blockly.Msg["SCRATCH_KEY_PRESSED"] = "Ocurre un evento cuando se presiona la tecla seleccionada";
Blockly.Msg["SCRATCH_MSG_RECEIVE"] = "El evento se producirá si se recibe el mensaje especificado.";
Blockly.Msg["SCRATCH_MOVE"] = "Mover el elemento un número de pasos determinado, (0-100)";
Blockly.Msg["SCRATCH_POINT_TOWARDS"] = "Rotar el elemento un número especificado de grados a la derecha, (0-360)";
Blockly.Msg["SCRATCH_ROTATE"] = "Como se quiere rotar un elemento";
Blockly.Msg["SCRATCH_SAY"] = "Decir una palabra o frase";
Blockly.Msg["SCRATCH_SAY_SEC"] = "Decir una palabra o frase durante un tiempo determinado (Max. 1 día)";
Blockly.Msg["SCRATCH_SET_X"] = "El elemento se movera un conjunto de posiciones en las coordenadas de x";
Blockly.Msg["SCRATCH_SET_Y"] = "El elemento se movera un conjunto de posiciones en las coordenadas de y";
Blockly.Msg["SCRATCH_SPRITE_PRESS"] = "El evento se activará cuando se haga clic en el objeto";
Blockly.Msg["SCRATCH_THINK_SEC"] = "Sale un globo de lo que piensa el personaje durante un tiempo determinado (Max. 1 día)";
Blockly.Msg["SCRATCH_THINK"] = "Sale un globo de lo que piensa el personaje";
Blockly.Msg["SCRATCH_TURN_LEFT"] = "El elemento va hacia donde indique el cursor";
...
Blockly.Msg["VARIABLES_CHANGE"] = "Cambiar una variable por otra";
...
Blockly.Msg["VARIABLES_HIDE"] = "Deja de mostrar una variable";
...
Blockly.Msg["VARIABLES_SHOW"] = "Mostrar la variable";
...
Blockly.Msg["VARIABLES_IS_CHARACTER"]="Variable de caracter";
Blockly.Msg["VARIABLES_IS_TEXT"]="Variable de texto";
Blockly.Msg["VARIABLES_IS_BOOLEAN"]="Variable de verdadero/false";
Blockly.Msg["VARIABLES_IS_SHORT"]="Variable de entero de 16 bits con signo";
Blockly.Msg["VARIABLES_IS_NUMBER"]="Variable de entero de 32 bits con signo";
Blockly.Msg["VARIABLES_IS_LONG"]="Variable de entero de 64 bits con signo";
Blockly.Msg["VARIABLES_IS_DECIMAL"]="Variable de decimal";
...
Blockly.Msg["TEXTS_HUE"] = "290";
Blockly.Msg["PROCEDURES_HUE"] = "150";

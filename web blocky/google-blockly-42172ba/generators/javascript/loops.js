...
Blockly.JavaScript['do_while'] = function(block) {
  ...
  var dropdown_repetir = block.getFieldValue('REPETIR')=='UNTIL';
  var value_name = Blockly.JavaScript.valueToCode(block, 'NAME', dropdown_repetir ? Blockly.JavaScript.ORDER_LOGICAL_NOT : Blockly.JavaScript.ORDER_NONE)||'false';
  statements_do=Blockly.JavaScript.addLoopTrap(statements_do,block.id);
  if(statements_do){
	  dropdown_repetir='!'+dropdown_repetir;
  }
  var code='{\n'+statements_do+'}\n while ('+dropdown_repetir+')';
  return code;
};
...
Blockly.JavaScript['infinity_loops'] = function(block) {
  return 'while(true);\n';
};
